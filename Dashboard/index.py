...
def get_diseases():
    df_api = get_df_from_url("http://ec2-3-129-71-228.us-east-2.compute.amazonaws.com/api/priv/ruv",0)
    df_dptos = df_api['Departamento'].value_counts().reset_index()
    return df_dptos
...
def generate_violin_plot():
    df = pd.read_csv("data/violin_data.csv")
    fig = go.Figure()
